...
function collectTitles() {
  return Array.from(
    document.querySelectorAll(
      "a[href^='/article'], a[href^='https://'], a[href^='/news/'], a[href^='./read/'], a[href*='.html']"
    )
  )
...
const modifyClickbait = (titles) => {
  document.querySelectorAll("a[href^='/article'], a[href^='https://'], a[href^='/news/'], a[href^='./read/'], a[href*='.html']").forEach((element) => {
